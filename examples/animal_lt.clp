...
; jeigu einamojo momento fakto pavadinimas ne root tai inicializuojame faktø bazæ pakraudami ið failo 
; "examples/animal.dat"
; bei pakrauname nauja faktà (current-node root)   
; Jess pasiþiûri ir randa  faktø faile "examples/animal.dat" kur yra  root iraðas ir 
; inicializuojama taisyklë  ask-decision-node-question          
